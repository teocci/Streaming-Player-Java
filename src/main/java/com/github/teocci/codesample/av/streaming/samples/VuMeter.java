...
import com.github.teocci.codesample.av.streaming.samples.skin.VuMeterSkin;
...
public class VuMeter extends Control
{
    ...
    public final ObjectProperty<Paint> sectionFill0Property()
    {
        if (null == sectionFill0) {
            ...
            {
                @Override
                public CssMetaData getCssMetaData() { return StyleableProperties.SECTION_FILL_0; }

                @Override
                public Object getBean() { return this; }

                @Override
                public String getName() { return "sectionFill0"; }
            };
        }
        return sectionFill0;
    }
    ...
    public final ObjectProperty<Paint> sectionFill1Property()
    {
        if (null == sectionFill1) {
            ...
            {
                @Override
                public CssMetaData getCssMetaData() { return StyleableProperties.SECTION_FILL_1; }

                @Override
                public Object getBean() { return this; }

                @Override
                public String getName() { return "sectionFill1"; }
            };
        }
        return sectionFill1;
    }
    ...
    public final ObjectProperty<Paint> sectionFill2Property()
    {
        if (null == sectionFill2) {
            ...
            {
                @Override
                public CssMetaData getCssMetaData() { return StyleableProperties.SECTION_FILL_2; }

                @Override
                public Object getBean() { return this; }

                @Override
                public String getName() { return "sectionFill2"; }
            };
        }
        return sectionFill2;
    }
    ...
    public final ObjectProperty<Paint> sectionFill3Property()
    {
        if (null == sectionFill3) {
            ...
            {
                @Override
                public CssMetaData getCssMetaData() { return StyleableProperties.SECTION_FILL_3; }

                @Override
                public Object getBean() { return this; }

                @Override
                public String getName() { return "sectionFill3"; }
            };
        }
        return sectionFill3;
    }
    ...
    public final ObjectProperty<Paint> sectionFill4Property()
    {
        if (null == sectionFill4) {
            ...
            {
                @Override
                public CssMetaData getCssMetaData() { return StyleableProperties.SECTION_FILL_4; }

                @Override
                public Object getBean() { return this; }

                @Override
                public String getName() { return "sectionFill4"; }
            };
        }
        return sectionFill4;
    }
    ...
    {
        return getClass().getResource("/css/vumeter.css").toExternalForm();
    }
