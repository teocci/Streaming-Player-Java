 ...
 */
public class JoystickPane  //extends Pane implements Runnable
{
//    /**
...
//     */
//    public JoystickPane(Context context)
//    {
//        this(context, null);
//    }
//
//
//    public JoystickPane(Context context, AttributeSet attribute, int definitionStyleAttribute)
//    {
...
//     */
//    public JoystickPane(Context context, AttributeSet attrs)
//    {
//        super(context, attrs);
//
...
//     * Here we get the center of the view and the radius to drawLevels all the shapes.
//     *
